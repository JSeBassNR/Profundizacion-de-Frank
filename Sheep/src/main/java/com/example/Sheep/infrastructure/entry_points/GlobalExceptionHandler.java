...
public class GlobalExceptionHandler {
 @ExceptionHandler(OvejaNotFoundException.class)
 public ResponseEntity<Map<String, Object>> handleNotFound(OvejaNotFoundException ex){
 return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of(
 "timestamp", LocalDateTime.now().toString(),
 "error", "Oveja no encontrada",
 "message", ex.getMessage()
));
 }

 @ExceptionHandler(PropietarioNotFoundException.class)
 public ResponseEntity<Map<String, Object>> handleOwnerNotFound(PropietarioNotFoundException ex){
 return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of(
 "timestamp", LocalDateTime.now().toString(),
 ...
 // Validación de parámetros (ConstraintViolation)
 ...
 "message", "Existen parámetros inválidos en la solicitud",
 "details", errors
));
 }

 // Tipo incorrecto en path/query (p.e. id no numérico)
 @ExceptionHandler(MethodArgumentTypeMismatchException.class)
 public ResponseEntity<Map<String, Object>> handleTypeMismatch(MethodArgumentTypeMismatchException ex){
 String name = ex.getName();
 String required = ex.getRequiredType() != null ? ex.getRequiredType().getSimpleName() : "tipo esperado";
 String msg = String.format("El parámetro '%s' tiene un tipo inválido. Se esperaba %s.", name, required);
 return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(Map.of(
 "timestamp", LocalDateTime.now().toString(),
 ...
 // JSON mal formado o tipos incorrectos en el cuerpo
 ...
 // Respaldo para integridad de datos de DB
