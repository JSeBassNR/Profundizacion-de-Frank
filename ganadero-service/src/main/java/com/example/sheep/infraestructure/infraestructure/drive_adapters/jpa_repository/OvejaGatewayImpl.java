...
import com.example.Sheep.infraestructure.drive_adapters.jpa_repository.OvejaDataJpaRepository;
...
public class OvejaGatewayImpl implements OvejaGateway {
 ...
 // validar identificaci�n duplicada de forma temprana
 if (oveja.getIdentificacion() != null) {
 com.example.Sheep.infraestructure.drive_adapters.jpa_repository.OvejaData existente = repository.findByIdentificacion(oveja.getIdentificacion());
 if (existente != null) {
 ...
 // Respaldo ante violaci�n de unicidad de DB
 throw new IdentificacionDuplicadaException(oveja.getIdentificacion());
 }
 }
 @Override
 ...
 // validar duplicado si cambia identificaci�n
 if (oveja.getIdentificacion() != null) {
